...
class fontService{
  ...
  static final _storge = GetStorage();
  ...
  static double get currentFontScale => _storge.read(_fontSizeKey)??fontSizeScales["Normal"]!;
  static String get currentFontFamily => _storge.read(_fontFamilyKey)??availableFonts["Poppins"]!;

  static Future<void> setFontScale(double scale) async {
    await _storge.write(_fontSizeKey, scale);
  }

  static Future<void> setFontFamily(String fontFamily) async {
    await _storge.write(_fontFamilyKey, fontFamily);
  }
